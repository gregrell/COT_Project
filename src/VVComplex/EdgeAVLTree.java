...
/**
 * Created by gregrell on 11/17/16.
 * Implemented as written by REF http://blog.blackbam.at/2012/05/04/avl-tree-implementation-in-java/
 * Some code taken as-is and some has been modified
 */
public class EdgeAVLTree {
...
class AvlNode implements Comparable {
    public int height;
    public Edge e;
    public Double angle;
    ...
    public AvlNode(Edge e, double angle, double distance){
        this.e=e;
        this.angle=angle;
        this.distance=distance;
        this.key = (int)angle;
    }
    public AvlNode(double angle){
        this.angle=angle;
        this.key = (int)angle;
        this.distance=angle;
    }
    ...
    public int compareTo(Object o) {
        ...
        Double thatAngle =((AvlNode) o).getAngle();
        boolean sameAngle=thisAngle.equals(thatAngle);
        if(!sameAngle){
            return this.getAngle().compareTo(((AvlNode)o).getAngle());
        }
        else{
            return this.getDistance().compareTo((((AvlNode)o).getDistance()));
        }
    }
}